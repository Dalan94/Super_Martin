\hypertarget{mobile__platform_8h}{\section{mobile\-\_\-platform.\-h File Reference}
...
Include dependency graph for mobile\-\_\-platform.\-h\-:
\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=350pt]{mobile__platform_8h__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{mobile__platform_8h__dep__incl}
\end{center}
\end{figure}
...
\subsubsection[{blit\-Platform}]{\setlength{\rightskip}{0pt plus 5cm}void blit\-Platform (
...
\subsubsection[{collision\-Platform}]{\setlength{\rightskip}{0pt plus 5cm}int collision\-Platform (
\begin{DoxyParamCaption}
...
\mbox{\tt in,out}  & {\em ps} & the platform set \\
\hline
\mbox{\tt in}  & {\em futur\-Location} & the try\-Movement variabla to test the future position \\
\hline
\end{DoxyParams}
...
\subsubsection[{create\-Platform}]{\setlength{\rightskip}{0pt plus 5cm}void create\-Platform (
\begin{DoxyParamCaption}
\item[{{\bf platform\-Set} $\ast$}]{ps, }
\item[{int}]{x1, }
\item[{int}]{y1, }
...
\subsubsection[{free\-Platform\-Set}]{\setlength{\rightskip}{0pt plus 5cm}void free\-Platform\-Set (
\begin{DoxyParamCaption}
\item[{{\bf platform\-Set} $\ast$}]{ps}
\end{DoxyParamCaption}
...
{\em int,out\mbox{]}} & ps the platform set \\
\hline
\end{DoxyParams}
...
\subsubsection[{init\-Platform\-Set}]{\setlength{\rightskip}{0pt plus 5cm}void init\-Platform\-Set (
\begin{DoxyParamCaption}
\item[{{\bf platform\-Set} $\ast$}]{ps}
\end{DoxyParamCaption}
...
\subsubsection[{move\-One\-Platform}]{\setlength{\rightskip}{0pt plus 5cm}void move\-One\-Platform (
\begin{DoxyParamCaption}
\item[{{\bf Character} $\ast$}]{c, }
...
\hline
\mbox{\tt in}  & {\em the} & number of the platform which is moved \\
\hline
...
\subsubsection[{move\-Platform}]{\setlength{\rightskip}{0pt plus 5cm}void move\-Platform (
\begin{DoxyParamCaption}
\item[{{\bf Character} $\ast$}]{c, }
\item[{{\bf platform\-Set} $\ast$}]{ps, }
\item[{{\bf list} $\ast$}]{l, }
...
\subsubsection[{platform\-Map}]{\setlength{\rightskip}{0pt plus 5cm}void platform\-Map (
\begin{DoxyParamCaption}
\item[{{\bf platform\-Set} $\ast$}]{ps, }
